...
AddContent("Toogle", "Auto Train 5", [[local args = {
    [1] = "Area_1",
    [2] = "TrainingMachine_1_5",
    [3] = workspace:WaitForChild("Areas"):WaitForChild("Area_1"):WaitForChild("TrainingMachines"):WaitForChild("TrainingMachine_1_5"):WaitForChild("Location")
}

game:GetService("ReplicatedStorage"):WaitForChild("Packages"):WaitForChild("_Index"):WaitForChild("sleitnick_knit@1.5.1"):WaitForChild("knit"):WaitForChild("Services"):WaitForChild("TrainingMachineService"):WaitForChild("RE"):WaitForChild("StartTraining"):FireServer(unpack(args))
]])

AddContent("Toogle", "Auto Train 6", [[local args = {
    [1] = "Area_1",
    [2] = "TrainingMachine_1_6",
    [3] = workspace:WaitForChild("Areas"):WaitForChild("Area_1"):WaitForChild("TrainingMachines"):WaitForChild("TrainingMachine_1_6"):WaitForChild("Location")
}
